  ...
  /*
This module interfaces with the Teos TCS3472x-series light color sensors (the units in this series vary only in I2C address and bus voltage)
Usage: 
...
Sets the number of integration cycles to use, from 1 to 256, 2.4ms per cycle. Effects maximum count and reduces noise. 

tcs.getValue(); 

returns an object with properties clear, red, green, and blue, corresponding to the values measured by the color sensor. 
